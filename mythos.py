...
Usage:
    python mythos.py              # Interactive REPL
    python mythos.py "question"   # One-shot mode
    python mythos.py --lock       # Launch lock screen (security)
    python mythos.py --version
    python mythos.py --update     # Force update wrapper
"""
